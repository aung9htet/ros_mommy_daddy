...
from child_publisher.msg import ChildPub # ROS child info subsciriber
...
class ChildMiro(object):
    ...
    def __init__(self):
        ...
        self.subscriber = rospy.Subscriber(topic_base_name + "/child_publisher", ChildPub, self.child_cb)
