...
class NodeDetectAudio(node.Node):
	...
	def __init__(self, sys):
		...
		# Create suscriber to the mic

		self.given_care = False
		...
		# Create callback function for the mic
		# apply furier transform
		# If the power around 10Hz is higher than some threshold
		# Set given_care to 1
		# Waggle the tail
